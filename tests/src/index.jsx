...
// cargo run -- --path ./tests/src/ --output-folder ./tests/expected-output/ --references-relative-to ./tests --default-domain test
...
export const App =React.memo(() => {
  ...
  return (
    ...
    <main>
      ...
      <p>{__dn(`draw`, 'You won 1 coffee.', 'You won %d coffees.', number)}</p>
    </main>
    </>
  )
});
